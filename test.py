...
spark.conf.set("spark.hadoop.fs.gs.auth.service.account.email", "export-upload@mixpanel-prod-1.iam.gserviceaccount.com")
spark.conf.set("spark.hadoop.fs.gs.project.id", "mixpanel-prod-1")
